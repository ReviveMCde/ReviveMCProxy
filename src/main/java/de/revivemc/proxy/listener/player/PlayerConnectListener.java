...
public class PlayerConnectListener implements Listener {
    ...
    public void onPlayerConnect(ServerConnectEvent event) {
        ...
        addDefaultProperty(iCloudPlayer);
    ...
    public void addDefaultProperty(ICloudPlayer iCloudPlayer) {
        addProperty(iCloudPlayer, "coins", 500);
        addProperty(iCloudPlayer, "color", "§9");
        addProperty(iCloudPlayer, "colorsub", "§b");
    }

    public void addProperty(ICloudPlayer iCloudPlayer, String key, Object value) {
        if (!iCloudPlayer.hasProperty(key)) {
            iCloudPlayer.setProperty(key, value);
            iCloudPlayer.update();
        }
    }
}
